...
class About extends Component {
  render() {
    return (
      <div className="about">
        <h1>About Rebecca</h1>
        <p><img src="/img/rebecca-web.jpg"></img>I'm a web developer based in Springfield, IL (STL native) specializing in HTML, CSS, JavaScript, jQuery, building themes on the .Net framework, and taking on new challenges.</p>
